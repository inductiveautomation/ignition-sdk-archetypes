...
const LibName = "${rootArtifactId}-client-components";
...
function copyToResources() {
    const resourceFolder = path.resolve(__dirname, '../../..', '${rootArtifactId}-gateway/src/main/resources/mounted/');
...
const config = {
    ...
    entry: {
        ${rootArtifactId}:  path.join(__dirname, "./typescript/${rootArtifactId}-client-components.ts")
    },
