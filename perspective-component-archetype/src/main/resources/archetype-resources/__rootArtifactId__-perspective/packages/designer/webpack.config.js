...
const LibName = "${rootArtifactId}-designer-components";
...
function copyToResources() {
    const resourceFolder = path.resolve(__dirname, '../../..', '${rootArtifactId}-gateway/src/main/resources/mounted/js/');
...
var config = {
    ...
    entry: {
        TamakiMESDesignComponents:  path.join(__dirname, "./typescript/${rootArtifactId}-designer-components.ts"),
    },
